...
csv_stanford = pandas.read_csv("openpolicingstanfordedu/ma-state-patrol.csv")
...
crime_reports_2015 = pandas.read_csv("databostongov-crime-incident-reports-august-2015-to-date-source-new-system/crime incident reports - 2015.csv")
...
crime_reports_2016 = pandas.read_csv("databostongov-crime-incident-reports-august-2015-to-date-source-new-system/crime incident reports - 2016.csv")
...
crime_reports_2017 = pandas.read_csv("databostongov-crime-incident-reports-august-2015-to-date-source-new-system/crime incident reports - 2017.csv")
...
crime_reports_2018 = pandas.read_csv("databostongov-crime-incident-reports-august-2015-to-date-source-new-system/crime incident reports - 2018.csv")
...
crime_reports_2019 = pandas.read_csv("databostongov-crime-incident-reports-august-2015-to-date-source-new-system/crime incident reports - 2019.csv")
...
crime_reports_2020 = pandas.read_csv("databostongov-crime-incident-reports-august-2015-to-date-source-new-system/crime incident reports - 2020.csv")
...
crime_reports_2021 = pandas.read_csv("databostongov-crime-incident-reports-august-2015-to-date-source-new-system/crime incident reports - 2021.csv")
...
crime_reports_2022 = pandas.read_csv("databostongov-crime-incident-reports-august-2015-to-date-source-new-system/crime incident reports - 2022.csv")
